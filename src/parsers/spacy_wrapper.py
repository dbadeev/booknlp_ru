...
Использование:
    ...
    # 4 варианта (2 формата × 2 токенизатора):
...
if __name__ == "__main__":
    ...
    ap.add_argument(
        "--tokenizer", choices=["internal", "razdel"], default="internal",
        help="Токенизатор (default: internal)"
    )
    ap.add_argument(
        "--output-format", choices=["native", "conllu"], default="native",
